...
- **Nextra**: Documentatie framework gebaseerd op Next.js
- **Markdown/MDX**: Eenvoudig te schrijven en te onderhouden
- **GitHub**: Voor versiebeheer en samenwerking
- **Supabase Auth**: Voor toegangscontrole op beveiligde secties
