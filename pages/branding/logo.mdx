...
>
  <div style={{ display: 'flex', justifyContent: 'center' }}>
    <img
      src='/branding/logo/png/kc-logo-gradientkleur.png'
...
<div style={{display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '20px'}}>
  <div style={{flex: '1 1 250px', minWidth: '250px'}}>
    <div style={{fontSize: '1.17em', fontWeight: 600, marginBottom: '0.5rem'}}>Primaire logo - Gradient Kleur</div>
  ...
  <div style={{flex: '1 1 250px', minWidth: '250px'}}>
    <div style={{fontSize: '1.17em', fontWeight: 600, marginBottom: '0.5rem'}}>Gradient Zwart-Wit</div>
    <div style={{fontSize: '0.9em', margin: '8px 0 0 0'}}>De zwart-wit gradient versie is ideaal voor donkere achtergronden waar geen kleur nodig is maar wel een onderscheidend element gewenst is.</div>
...
Alle logo varianten zijn beschikbaar op de [downloads](/branding/downloads) pagina in verschillende formaten.
